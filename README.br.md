...
nix run nixpkgs#opencode           # ou github:n0facearia/n0face-opencode-fork para a branch dev mais recente
```
...
O OpenCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/n0facearia/n0face-opencode-fork/releases) ou em [opencode.ai/download](https://opencode.ai/download).
