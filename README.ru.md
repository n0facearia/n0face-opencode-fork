...
nix run nixpkgs#opencode           # или github:n0facearia/n0face-opencode-fork для самой свежей ветки dev
```
...
OpenCode также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/n0facearia/n0face-opencode-fork/releases) или с [opencode.ai/download](https://opencode.ai/download).
