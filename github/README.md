   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: n0facearia/n0face-opencode-fork/github@latest
           env:
...
This is an early release. If you encounter issues or have feedback, please create an issue at https://github.com/n0facearia/n0face-opencode-fork/issues.
