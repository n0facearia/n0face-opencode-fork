...
nix run nixpkgs#opencode           # або github:n0facearia/n0face-opencode-fork для найновішої dev-гілки
```
...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/n0facearia/n0face-opencode-fork/releases) або [opencode.ai/download](https://opencode.ai/download).
