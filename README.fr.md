...
nix run nixpkgs#opencode           # ou github:n0facearia/n0face-opencode-fork pour la branche dev la plus récente
```
...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/n0facearia/n0face-opencode-fork/releases) ou [opencode.ai/download](https://opencode.ai/download).
