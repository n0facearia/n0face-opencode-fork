...
nix run nixpkgs#opencode           # lub github:n0facearia/n0face-opencode-fork dla najnowszej gałęzi dev
```
...
OpenCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/n0facearia/n0face-opencode-fork/releases) lub z [opencode.ai/download](https://opencode.ai/download).
