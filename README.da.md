...
OpenCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/n0facearia/n0face-opencode-fork/releases) eller [opencode.ai/download](https://opencode.ai/download).
