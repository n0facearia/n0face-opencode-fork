...
<p align="center">
  ...
  <a href="https://github.com/n0facearia/n0face-opencode-fork/actions/workflows/publish.yml"><img alt="สถานะการสร้าง" src="https://img.shields.io/github/actions/workflow/status/n0facearia/n0face-opencode-fork/publish.yml?style=flat-square&branch=dev" /></a>
</p>
...
nix run nixpkgs#opencode           # หรือ github:n0facearia/n0face-opencode-fork สำหรับสาขาพัฒนาล่าสุด
```
...
OpenCode มีให้ใช้งานเป็นแอปพลิเคชันเดสก์ท็อป ดาวน์โหลดโดยตรงจาก [หน้ารุ่น](https://github.com/n0facearia/n0face-opencode-fork/releases) หรือ [opencode.ai/download](https://opencode.ai/download)
