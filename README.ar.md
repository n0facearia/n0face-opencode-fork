...
nix run nixpkgs#opencode           # او github:n0facearia/n0face-opencode-fork لاحدث فرع dev
```
...
يتوفر OpenCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/n0facearia/n0face-opencode-fork/releases) او من [opencode.ai/download](https://opencode.ai/download).
