...
nix run nixpkgs#opencode           # 或用 github:n0facearia/n0face-opencode-fork 获取最新 dev 分支
```
...
OpenCode 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/n0facearia/n0face-opencode-fork/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下载。
