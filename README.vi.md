...
nix run nixpkgs#opencode           # hoặc github:n0facearia/n0face-opencode-fork cho nhánh dev mới nhất
```
...
OpenCode cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/n0facearia/n0face-opencode-fork/releases) hoặc [opencode.ai/download](https://opencode.ai/download).
