import { AppIcon } from "@am-ai/ui/app-icon"
...
import { Keybind } from "@am-ai/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_AM_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("am-titlebar-center"))
    setRightMount(document.getElementById("am-titlebar-right"))
  })
