...
beforeAll(async () => {
  ...
  mock.module("@am-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@am-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@am-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@am-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
