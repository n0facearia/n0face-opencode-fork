...
const releaseId = process.env.AM_RELEASE
if (!releaseId) throw new Error("AM_RELEASE is required")

const version = process.env.AM_VERSION
if (!version) throw new Error("AM_VERSION is required")
