...
export const TypeId: TypeId = "~@am-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@am-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@am-ai/effect-sqlite-node/NodeSqliteClient")
