...
- **Via Mise**
  ...
  ```bash
  mise use -g github:n0facearia/n0face-opencode-fork
  ```

- **Via Docker**

  ```bash
  docker run -it --rm ghcr.io/n0facearia/n0face-opencode-fork
  ```

Le support de l'installation de OpenCode sur Windows à l'aide de Bun est actuellement en cours de développement.

Vous pouvez également récupérer le binaire dans les [Releases](https://github.com/n0facearia/n0face-opencode-fork/releases).
