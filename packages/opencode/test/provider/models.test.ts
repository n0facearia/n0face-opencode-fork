...
// test/preload.ts pins AM_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.AM_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.AM_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.AM_MODELS_PATH = undefined
  Flag.AM_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.AM_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.AM_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
