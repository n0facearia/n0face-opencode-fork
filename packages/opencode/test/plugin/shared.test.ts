...
describe("parsePluginSpecifier", () => {
  ...
  test("parses scoped npm package without version", () => {
    expect(parsePluginSpecifier("@am/acme")).toEqual({
      pkg: "@am/acme",
      version: "latest",
    })
  })
  ...
  test("parses scoped npm package with version", () => {
    expect(parsePluginSpecifier("@am/acme@1.0.0")).toEqual({
      pkg: "@am/acme",
      version: "1.0.0",
    })
  })
  ...
  test("parses scoped package with git+https url", () => {
    expect(parsePluginSpecifier("@am/acme@git+https://github.com/opencode/acme.git")).toEqual({
      pkg: "@am/acme",
      version: "git+https://github.com/opencode/acme.git",
    })
  })
  ...
  test("parses scoped package with git+ssh url containing another @", () => {
    expect(parsePluginSpecifier("@am/acme@git+ssh://git@github.com/opencode/acme.git")).toEqual({
      pkg: "@am/acme",
      version: "git+ssh://git@github.com/opencode/acme.git",
    })
  })
