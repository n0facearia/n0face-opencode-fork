...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AM_CALLER", () => {
    process.env["AM_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AM_CALLER", () => {
    process.env["AM_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AM_CALLER", () => {
    process.env["AM_CALLER"] = "unknown"
