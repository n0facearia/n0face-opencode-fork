...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@am-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@am/ToolRegistry") {}
