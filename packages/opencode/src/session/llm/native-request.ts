import type { JsonSchema, LLMRequest, ProviderMetadata } from "@am-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@am-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @am-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
