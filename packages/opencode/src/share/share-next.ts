import type * as SDK from "@am-ai/sdk/v2"
...
const disabled = process.env["AM_DISABLE_SHARE"] === "true" || process.env["AM_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@am/ShareNext") {}
