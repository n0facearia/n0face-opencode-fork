import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@am-ai/sdk/v2"
import { SessionTurn } from "@am-ai/ui/session-turn"
import { SessionReview } from "@am-ai/ui/session-review"
import { DataProvider } from "@am-ai/ui/context"
import { FileComponentProvider } from "@am-ai/ui/context/file"
import { WorkerPoolProvider } from "@am-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@am-ai/ui/logo"
import { IconButton } from "@am-ai/ui/icon-button"
import { ProviderIcon } from "@am-ai/ui/provider-icon"
import { iife } from "@am-ai/core/util/iife"
import { Binary } from "@am-ai/core/util/binary"
import { NamedError } from "@am-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@am-ai/ui/tabs"
import { MessageNav } from "@am-ai/ui/message-nav"
import { FileSSR } from "@am-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@am-ai/ui/pierre/worker").then((m) => ({
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/n0facearia/n0face-opencode-fork"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
