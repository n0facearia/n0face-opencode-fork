...
nix run nixpkgs#opencode           # oder github:n0facearia/n0face-opencode-fork für den neuesten dev-Branch
```
...
OpenCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/n0facearia/n0face-opencode-fork/releases) oder [opencode.ai/download](https://opencode.ai/download) herunter.
