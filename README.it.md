...
<p align="center">
  ...
  <a href="https://github.com/n0facearia/n0face-opencode-fork/actions/workflows/publish.yml"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/n0facearia/n0face-opencode-fork/publish.yml?style=flat-square&branch=dev" /></a>
</p>
...
nix run nixpkgs#opencode           # oppure github:n0facearia/n0face-opencode-fork per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/n0facearia/n0face-opencode-fork/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
