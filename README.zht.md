...
nix run nixpkgs#opencode           # 或使用 github:n0facearia/n0face-opencode-fork 以取得最新開發分支
```
...
OpenCode 也提供桌面版應用程式。您可以直接從 [發佈頁面 (releases page)](https://github.com/n0facearia/n0face-opencode-fork/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下載。
