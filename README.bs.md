...
nix run nixpkgs#opencode           # ili github:n0facearia/n0face-opencode-fork za najnoviji dev branch
```
...
OpenCode je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/n0facearia/n0face-opencode-fork/releases) ili sa [opencode.ai/download](https://opencode.ai/download).
