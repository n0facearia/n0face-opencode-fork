...
Generates UPCOMING_CHANGELOG.md by running the am changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for am run (default: low)
      --quiet            Suppress am command output unless it fails
