...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/n0facearia/n0face-opencode-fork/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for n0facearia/n0face-opencode-fork...\n")
...
console.log("Fetching npm all-time downloads for am-ai...\n")
const npmDownloads = await fetchNpmDownloads("am-ai")
