...
nix run nixpkgs#opencode           # eller github:n0facearia/n0face-opencode-fork for nyeste dev-branch
```
...
OpenCode er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/n0facearia/n0face-opencode-fork/releases) eller [opencode.ai/download](https://opencode.ai/download).
