...
nix run nixpkgs#opencode           # o github:n0facearia/n0face-opencode-fork para la rama dev más reciente
```
...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/n0facearia/n0face-opencode-fork/releases) o desde [opencode.ai/download](https://opencode.ai/download).
