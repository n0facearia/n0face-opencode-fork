...
nix run nixpkgs#opencode           # または github:n0facearia/n0face-opencode-fork で最新 dev ブランチ
```
...
OpenCode はデスクトップアプリとしても利用できます。[releases page](https://github.com/n0facearia/n0face-opencode-fork/releases) から直接ダウンロードするか、[opencode.ai/download](https://opencode.ai/download) を利用してください。
