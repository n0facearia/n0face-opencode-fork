...
nix run nixpkgs#opencode           # ή github:n0facearia/n0face-opencode-fork με βάση την πιο πρόσφατη αλλαγή από το dev branch
```
...
Το OpenCode είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/n0facearia/n0face-opencode-fork/releases) ή το [opencode.ai/download](https://opencode.ai/download).
