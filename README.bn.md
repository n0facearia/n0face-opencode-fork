...
nix run nixpkgs#opencode           # or github:n0facearia/n0face-opencode-fork for latest dev branch
```
...
OpenCode ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/n0facearia/n0face-opencode-fork/releases) অথবা [opencode.ai/download](https://opencode.ai/download) থেকে ডাউনলোড করুন।
